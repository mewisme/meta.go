...
type FacebookUser = model.FacebookUser
type SearchResult = model.SearchResult
type Notification = model.Notification
type Post = model.Post
type PostOwnership = model.PostOwnership
type MarketplaceLocation = model.MarketplaceLocation
type MarketplaceListingInput = model.MarketplaceListingInput
type MarketplaceListing = model.MarketplaceListing
type Thread = model.Thread
type ThreadList = model.ThreadList
...
const (
	...
	PostOwned              = model.PostOwned
	PostShared             = model.PostShared
